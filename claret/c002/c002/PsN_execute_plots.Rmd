...
#Created 2022-05-19 at 10:58

xpose.runno <- '002.ctl'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/data/home/kyleb/git/mrgsolve/nmtests/claret/c002/c002/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.26.1/PsN_5_2_6/R-scripts' # This is not used
raw.results.file <- 'raw_results_c002.csv'
theta.labels <- c('THETA1')
theta.fixed <- c(TRUE)
