...
#Created 2022-10-15 at 14:44

xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/data/home/kyleb/git/mrgsolve/nmtests/time-varying/2001/2001/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.26.1/PsN_5_3_0/R-scripts' # This is not used
raw.results.file <- 'raw_results_2001.csv'
theta.labels <- c('','_','__')
theta.fixed <- c(TRUE,TRUE,TRUE)
omega.labels <- c('OMEGA(1,1)','OMEGA(2,2)','OMEGA(3,3)')
omega.fixed <- c(TRUE,TRUE,TRUE)
